        ...
        <div className="about-container">
            ...
            <div className="about-main">
                <p className="about-content">
                    ...
                    I created this as my final dessertation project with Applied Roots, and I have also deployed this project
                    so people can use it and do some basic yoga poses with joy.
                ...
                <div className="developer-info">
                    ...
                    <p className="about-content">I am Arjun Sharma, I am Machine Learning aspirant, AI Enthusiastic,
                        I love to work with technology and 
                        I hope this project will help you. 
                    </p>
                    <h4>Contact</h4>
                    <a href="https://github.com/arjun7042"><p  className="about-content">GitHub</p></a>
                </div>
            </div>
        </div>
    )
